...
void runApp(){
		...
		*temp = lou;
		...
		Collection *morePeople = new Collection(people);   //same as Collection morePeople(people);
		cout << *morePeople;
